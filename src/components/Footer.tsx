...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 rounded-3xl overflow-x-hidden m-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Your all-in-one academic companion. Access past papers, manage
              tasks, and organize your study materials in one place.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                <a
                  href="mailto:contact@studyconnect.com"
