...
const Pricing = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes — we are constantly improving Study Connect and Premium users will always get early access to new features.",
    },
  ];
    ...
    <div className="bg-white min-h-screen py-12 px-6">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="mt-3 text-md md:text-lg text-gray-600">
          Get the most out of Study Connect with AI-powered features built for
          students.
        </p>
      </div>
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <div
          ...
          } cursor-pointer rounded-3xl p-6 shadow-lg hover:shadow-xl transition flex flex-col justify-between`}
        >
          <div>
      ...
      {!user ||
        (profile?.role === "free" && (
          <div className="mt-16 max-w-4xl mx-auto text-center border border-gray-300 rounded-3xl p-6">
            ...
            <UpgradeToPremiumButton extraClasses="mt-4" />
          </div>
        ))}
    </div>
  );
