      ...
      <div className="flex flex-1 items-center justify-center bg-gray-50 p-4 px-2 lg:p-12">
        <div className="max-w-md w-full bg-white shadow-lg rounded-xl p-6 space-y-6">
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            {
              isLoading ? <button disabled type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex items-center w-full justify-center font-medium">
          ...
          {isLogin && showForgotPassword && (
            <div className="bg-blue-50 p-3 rounded-md mt-2">
              <form onSubmit={handleForgotPassword} className="space-y-2">
                <label htmlFor="resetEmail" className="block text-sm font-medium text-gray-700">Enter your email to reset password</label>
                <input
                  id="resetEmail"
                  name="resetEmail"
                  type="email"
